...
function updateAnswers(data) {
  ...
  for (var i = 0; i < data.answers.length; i++) {
    document.getElementById('answer-options-wrapper').innerHTML += '<div class="row"> <div class="col m1 s0"></div><div class="col m10 s12 answer-options pink darken-4" userName="'+data.answers[i].username+'" onclick="submitSelectedAns('+i+')"> <h5 class="answer-options-answer">'+data.answers[i].ans+'<h5> </div><div class="col m1 s0"></div></div>';
  }
}
  ...
  for (var i = 0; i < data.length; i++) {
    if (data[i].name == userName) {
      if (data[i].psyched_by == '') {
        ...
        document.getElementById('pyched-by-user').innerHTML = data.psyched_by;
...
function showLeaderboard(data) {
  ...
  for (var i = 0; i < data.users.length; i++) {
    if (i==0) {
      document.getElementById('leaderboard-users').innerHTML += '<li class="collection-item avatar center"> <img src="/static/psych/images/gold-medal.svg" alt="" class="circle"> <span class="title leaderboard-name">'+data.users[i].name+'</span> </li>'
    } else if (i==1) {
      document.getElementById('leaderboard-users').innerHTML += '<li class="collection-item avatar center"> <img src="/static/psych/images/silver-medal.svg" alt="" class="circle"> <span class="title leaderboard-name">'+data.users[i].name+'</span> </li>'
    } else if (i==2) {
      document.getElementById('leaderboard-users').innerHTML += '<li class="collection-item avatar center"> <img src="/static/psych/images/bronze-medal.svg" alt="" class="circle"> <span class="title leaderboard-name">'+data.users[i].name+'</span> </li>'
    } else {
      document.getElementById('leaderboard-users').innerHTML += '<li class="collection-item avatar center"> <img src="/static/psych/images/normal-medal.svg" alt="" class="circle"> <span class="title leaderboard-name">'+data.users[i].name+'</span> </li>'
    }
  }
